...
AppPublisher=Om Rajguru
AppPublisherURL=https://omrajguru.com/
AppSupportURL=https://omrajguru.com/contact
AppUpdatesURL=https://github.com/omrajguru05/nirmaan
...
begin
  Result := True;
    ...
    if not WizardSilent() and IsAdmin() then begin
      if MsgBox('This User Installer is not meant to be run as an Administrator. If you would like to install Nirmaan for all users in this system, download the System Installer instead from https://github.com/omrajguru05/nirmaan/releases. Are you sure you want to continue?', mbError, MB_OKCANCEL) = IDCANCEL then begin
        Result := False;
      end;
    end;
  #endif
